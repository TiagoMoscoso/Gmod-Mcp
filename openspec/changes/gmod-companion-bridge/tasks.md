...
- [x] 1.2 Write the chosen transport and failure modes into `docs/architecture/companion.md` and verify the doc states the winner and what was rejected
- [x] 1.3 Implement that transport on both Companion and GLua and verify a hello round-trip works with the real addon plus Companion process
...
- [x] 3.4 Ensure advertised URL host is loopback and verify it is never `0.0.0.0`
